...
@section('content')
    <div class="" role="tabpanel" data-example-id="togglable-tabs">
        <ul id="myTab" class="nav nav-pills bar_tabs" role="tablist">
            <li class="nav-item"><a class="nav-link active" href="#tab_content1" id="home-tab" role="tab" data-toggle="tab"
                    aria-expanded="true">{{ __lang('settings') }}</a>
            </li>
            <li id="methodtab" class="nav-item"><a class="nav-link" href="#tab_content2" role="tab" id="profile-tab"
                    data-toggle="tab" aria-expanded="false">{{ __lang('currencies') }}</a>
            </li>
        </ul>
        <div id="myTabContent" class="tab-content">
            <div role="tabpanel" class="tab-pane show active" id="tab_content1" aria-labelledby="home-tab">
                ...
                <form method="post"
                    action="{{ route('admin.payment-gateways.save', ['paymentMethod' => $paymentMethod->id]) }}">
                    @csrf
                    <div>
                        <div>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input required type="text" name="label"
                                                value="{{ old('label', $paymentMethod->label) }}" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" id="is_global" type="checkbox" name="is_global"
                                                value="1" @if (old('is_global', $paymentMethod->is_global) == 1) checked @endif>

                                            <label class="form-check-label"
                                                for="inlineCheckbox1">{{ __lang('all-currencies?') }}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input name="sort_order" type="text" class="number form-control"
...
@section('footer')
    ...
    <script type="text/javascript">
        $(function() {
            $('#currencylist').load(
                '{{ adminUrl(['controller' => 'payment', 'action' => 'currencies', 'id' => $paymentMethod->id]) }}',
                function() {
                    $('.select2').select2();
                });
