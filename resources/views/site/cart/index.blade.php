                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td><input  id="method-{{ $method->id }}"   @php  if($count==0): @endphp  checked="checked" @php  endif;  @endphp required="required" type="radio" name="payment_method" value="{{  $method->id  }}"/> </td>
                                    <td><label for="method-{{ $method->id }}">{{  $method->label  }}</label></td>
                                </tr>
                                @php  $count++;  @endphp
                                @endforeach
                            </table>
