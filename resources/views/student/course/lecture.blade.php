                                                    ...
                                                    <div  class="tab-pane  fade show  @php  if($count==1): @endphp active @php  endif;  @endphp" id="pagetab{{  $page->id  }}">
                                                        ...
                                                        <div @php  if($page->type=='v'):  @endphp class="videobox" style="text-align: center"  @php  endif;  @endphp>
                                                            ...
                                                            <div style="text-align: center">
                                                                <a href="#" onclick="startMeeting('{{ trim($zoomData['meeting_id']) }}','{{ trim($zoomData['password']) }}','{{ generate_zoom_signature(setting('zoom_key'), setting('zoom_secret'), trim($zoomData['meeting_id']), 0) }}')" class="btn btn-primary btn-lg"><i class="fa fa-video"></i> @lang('default.join-meeting')</a>
